...
class KGEModel(nn.Module):
    def __init__(self, model_name, nentity, nrelation, hidden_dim, gamma,
        ...
        if model_name == 'MDE':
            ...
            self.entity_embedding12 = nn.Parameter(torch.zeros(nentity, self.entity_dim, device=device))
            nn.init.uniform_(
            ...
            self.relation_embedding3 = nn.Parameter(torch.zeros(nrelation, self.relation_dim*3, device=device))
    ...
    def forward(self, sample, mode='single'):
        ...
        if mode == 'single' and self.model_name != 'MDE':
            ...
            head = [h0, h1,  h3, h4, h5, h7, h8, h9, h10, h11, h12, h_d]#h2, h6,
            relation = [r0, r1,  r3, r4, r5,  r7]#r2,r6,
            tail = [t0, t1,  t3, t4, t5,  t7, t8, t9, t10, t11, t12, t_d]#t2,t6,
    ...
    def MDE(self, h, r, t, mode):
        ...
        r_f_4 = torch.abs((torch.cos(h[11][3]) - torch.cos(t[11][3])))
        ...
        score_f_c4 = torch.norm((h[9] - t[9]), p=2, dim=2)
        score_f_c5 = torch.norm((h[10] - t[10]), p=2, dim=2)
